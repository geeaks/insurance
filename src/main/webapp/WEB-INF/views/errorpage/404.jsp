...
<svg width="1920" style="position:absolute;z-index: 10" >
	<path stroke-width="3" d="M0,80S960,44.32499999999999,1920,80" stroke="#bbbbbb" fill="none"></path>
</svg>
</div>
<div id="molo-image" style="text-align:center;z-index: 10;margin-top:128px; " align="center">
	<img style="display: inline; margin-top: -40px;" id="molo" src="${basePath}/images/molome_404.png">
</div>
<div id="error" style="text-align: center; padding-top: 50px; height: 86px;">
	<span style="font-size:36px;color:#7C999B;font-weight:bold">404 Error</span>
	<br />
	<span style="font-size:26px;color:#AAAAAA">页面没有找到</span>
</div>
